...
const ContactUs = () => {
  ...
  return (
    <ThemeProvider theme={theme}>
      <Box className="bg-white min-h-screen">
        ...
        <Box className="bg-amber-600  min-h-screen flex items-center justify-center py-16">
  <Container maxWidth="md">
    ...
    <Paper elevation={0} className="p-8 rounded-lg bg-white shadow-md">
    <form onSubmit={handleSubmit}>
  <Box className="flex flex-col gap-6">
    <Box>
      <Typography
        variant="subtitle2"
        className="text-gray-600 mb-1 uppercase text-xs font-medium"
      >
        Full Name
      </Typography>
      <TextField
      ...
      >
        ...
        <Box className="bg-gradient-to-r from-gray-900 to-gray-800 py-16 text-center">
          <Container maxWidth="md">
            ...
            <Grid container spacing={6} wrap="nowrap" className="mt-4">
  <Grid item xs={4}>
  ...
  <Container maxWidth="lg">
    <Grid container spacing={4}>
      ...
      <Grid item xs={12} md={4}>
        <Box className="mb-6">
          <Box className="flex items-center mb-4">
            <img
              src="https://crowdera-platform.s3.ap-south-1.amazonaws.com/CDRA/campaign-assets/0eb4c68e-785f-4f51-a735-37faa46fbeff_thumbnail_0fff8a35-a963-4bf1-8c42-3c98f5b15207_thumbnail_30e11477-9362-4975-b9dc-ab8dbca65e4a_thumbnail_Joyful%20Minds%20logo%20v4.png"
      ...
      <Grid item xs={12} sm={6} md={2}>
        ...
        <Box className="flex flex-col space-y-2">
          {["Home", "About Us", "Causes", "Report", "Login", "Contact"].map((link) => (
            <Typography
              key={link}
              variant="body2"
              component="a"
      ...
      <Grid item xs={12} sm={6} md={3}>
        ...
        <Box className="flex flex-col space-y-3">
          {[
            ...
            <Box key={post} className="flex items-center">
